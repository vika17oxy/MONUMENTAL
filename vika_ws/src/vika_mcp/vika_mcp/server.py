...
Skeleton only — concrete tool implementations land in vika_mcp.tools.*
"""
...
log = logging.getLogger("vika_mcp")

server = Server("vika-mcp")
...
async def call_tool(name: str, arguments: dict[str, Any]) -> list[TextContent]:
    # TODO: dispatch to vika_mcp.tools.<name>
